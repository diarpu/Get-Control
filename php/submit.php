...
$mail->Username = 'getcontrol@gruva.net';                 // SMTP username
...
$mail->setFrom('getcontrol@gruva.net', 'Get Control');  // Host
                                                                    ...
                                                                    <tr>
                                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:"Open Sans",sans-serif;"
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <p style="font-size: 14px; line-height: 140%;">
                                                                                    <strong><span
                                                                                            style="font-size: 16px; line-height: 22.4px; margin-left: 10px">GET CONTROL</span></strong>
                                                                                </p>
                                                                                <p style="font-size: 14px; line-height: 140%;">&nbsp;
                                                                                </p>
                                                                            </div>
